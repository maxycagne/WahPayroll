...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#3d0d74] via-[#50109a] to-[#6c2eb9] p-4 md:p-8 flex items-center justify-center">
      {}
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl grid-cols-1 overflow-hidden rounded-2xl border border-white/20 bg-white/95 shadow-2xl md:h-[calc(100vh-4rem)] md:grid-cols-2 w-full">
        ...
        <section className="flex items-center justify-center overflow-y-auto bg-white p-6 md:p-10">
          <Card className="w-full max-w-md border border-slate-200 shadow-none bg-white">
                ...
                <FieldGroup className="space-y-5">
                  <Field className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="h-11 rounded-lg border-slate-300 bg-white text-gray-900"
                    />
                  </Field>
                  ...
                  <Field className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        required
                        className="h-11 w-full rounded-lg border-slate-300 bg-white text-gray-900 pr-10"
                      />
                      <button
                        type="button"

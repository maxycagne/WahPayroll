        ...
        <div className="flex items-center gap-3">
          <label className="flex items-center gap-2 text-[0.9rem] text-gray-500">
            ...
            <input
              ...
              className="px-2.5 py-1.5 border border-gray-300 rounded-lg text-[0.9rem]"
            />
          </label>
        ...
        <table className="w-full border-collapse bg-white rounded-xl overflow-hidden">
          <thead>
            <tr>
              ...
              <th className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100 bg-wah-table-head text-wah-dark font-semibold whitespace-nowrap font-semibold">
                Net Pay
              </th>
            </tr>
          </thead>
          <tbody>
            {samplePayroll.map((p) => (
              <tr key={p.id} className="hover:bg-wah-table-hover">
                ...
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100 bg-wah-table-head font-semibold">
                  {fmt(p.net)}
                </td>
              </tr>
            ))}
          ...
          <tfoot>
            <tr>
              <td
                colSpan={7}
                className="px-3 py-2.5 text-right text-[0.85rem] border-b border-gray-100 font-bold"
              >
                Total Net Payroll
              </td>

    ...
    <div className="max-w-full">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-3 my-5">
        {cards.map((c) => (
          <div
            key={c.label}
            className="bg-white rounded-[10px] px-4 py-4 flex flex-col gap-1 border-t-4"
          ...
          <table className="w-full border-collapse bg-white rounded-xl overflow-hidden">
            ...
            <tbody>
              <tr className="hover:bg-wah-table-hover">
                ...
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100">
                  Filed Vacation Leave
                </td>
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100">
                  <span className="px-3 py-0.5 rounded-full text-[0.78rem] font-semibold bg-yellow-100 text-yellow-800">
                    Pending
                  </span>
                </td>
              </tr>
              <tr className="hover:bg-wah-table-hover">
                ...
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100">
                  <span className="px-3 py-0.5 rounded-full text-[0.78rem] font-semibold bg-green-100 text-green-800">
                    Approved
                  </span>
                </td>
              </tr>
              ...
              <tr className="hover:bg-wah-table-hover">
                ...
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100">
                  Filed Birthday Leave
                </td>
                <td className="px-3 py-2.5 text-left text-[0.85rem] border-b border-gray-100">
                  <span className="px-3 py-0.5 rounded-full text-[0.78rem] font-semibold bg-red-100 text-red-800">
                    Denied
                  </span>
                </td>
              </tr>

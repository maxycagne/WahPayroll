      ...
      <div className="min-h-screen grid place-items-center p-7 bg-gradient-to-br from-[#50109a] to-wah-accent">
        <div className="w-full max-w-[500px] bg-wah-card rounded-[14px] overflow-hidden shadow-lg">
          <section className="px-12 py-16 flex flex-col items-center">
            <img className="w-[150px] h-[150px] object-contain mb-6" src="/images/wah-logo.png" alt="WAH logo" />
            ...
            <form className="mt-[34px] w-full max-w-[340px] grid gap-3" onSubmit={handleLogin}>
              ...
              <div className="mt-2.5 grid grid-cols-1 gap-2.5">
                <button type="submit" className="h-12 rounded-xl border-0 text-white text-xl font-semibold cursor-pointer bg-gradient-to-r from-wah-primary to-wah-lighter">
                  Log in
                </button>
              </div>
            </form>

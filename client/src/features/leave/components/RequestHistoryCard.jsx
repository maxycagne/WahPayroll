              ...
              myRequestHistory.map((entry) => (
                ...
                >
                  ...
                  <td className="px-4 py-2.5 text-right">
                    <span
                      className={`inline-flex items-center rounded-md px-2.5 py-0.5 text-[0.6rem] font-bold uppercase tracking-wider ${badgeClass[entry.final_status] || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"}`}
                    >
                      {entry.final_status}
                    </span>
                  </td>

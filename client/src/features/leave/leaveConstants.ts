...
export const badgeClass = {
  ...
  "Awaiting Clearance": "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400",
  "Clearance Uploaded": "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",
  "Officially Resigned": "bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400",

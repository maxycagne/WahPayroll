  ...
  return (
    <aside className="bg-gradient-to-b from-wah-sidebar-start to-wah-mid text-white flex flex-col sticky top-[42px] h-[calc(100vh-42px)] overflow-y-auto">
      <div className="flex justify-center items-center px-4 pt-7 pb-6">
        <img src="/images/wah-logo.png" alt="WAH" className="w-[120px] h-[120px] object-contain" />
      </div>
      ...
      <button className="mx-4 mb-4 mt-3.5 px-2.5 py-2.5 rounded-[10px] border border-white/30 bg-transparent text-white cursor-pointer text-[0.92rem] transition-colors duration-150 hover:bg-white/15" onClick={onLogout}>
        ⎋ Log out
      </button>
    </aside>
  )
